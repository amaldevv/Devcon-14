...
{
    /// <summary>
    /// Implementation of the SponsorsDSSchema Data Schema.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class SponsorsDSSchema : BindableBase
    {
	    /// <summary>
        /// Identifier for instances created according SponsorsDSSchema Data Schema.
        /// </summary>
        ...
        {
            var cmp = obj as SponsorsDSSchema;
			
			if(cmp == null) return false;
			
			return Equals(Title, cmp.Title) && Equals(Subtitle, cmp.Subtitle) && Equals(Image, cmp.Image);
        }
